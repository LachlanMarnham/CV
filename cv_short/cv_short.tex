...
\renewcommand*{\maketitle}{%
 ...
 \makeatother
\name{\hspace*{-2cm} Lachlan}{Marnham}

\title{Curriculum Vitae}

%\address{Flat 4, 49 Kingsgate Road, London, United Kingdom, NW6 4TD}{}{} 

\extrainfo{\hspace*{-2.6cm} \faGlobe \space \href{www.lachlanmarnham.com}{lachlanmarnham.com} | \faGithub \space \href{https://github.com/LachlanMarnham}{LachlanMarnham} | \faEnvelope \space \href{mailto:lachlan.marnham@gmail.com}{lachlan.marnham@gmail.com} | \faMobile \space +44 (0)7856516125 }
\begin{document}
...
\item{\cventry{\small{April 2012--December 2016}}{\small{Doctoral Researcher}}{University of Exeter}{Exeter, UK}{}{\small{
\begin{itemize}
...
\begin{itemize}
\small{
\item{\textbf{Doctoral Project:} \textit{\small{`Bi-electron bound states in single- and double-layer graphene nanostructures'}}
\small{\begin{itemize}
...
\vspace{5pt}
\begin{itemize}\small{
\item{\textbf{Exeter Students’ Guild Teaching Awards} \small{(twice nominated) \textit{``Best Graduate Teaching Assistant''}}}
\item{\textbf{University of Exeter Early Careers Network Poster Prize} \small{(2015)}}
