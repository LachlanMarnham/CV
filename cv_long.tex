...
\address{Flat 4, 49 Kingsgate Road, London, United Kingdom, NW6 4TD}{}{}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
\phone[mobile]{+44 7856516125}                   % optional, remove / comment the line if not wanted
%\phone[fixed]{01234 123456}                    % optional, remove / comment the line if not wanted
%\phone[fax]{+3~(456)~789~012}                      % optional, remove / comment the line if not wanted
\email{lachlan.marnham@gmail.com}                               % optional, remove / comment the line if not wanted
